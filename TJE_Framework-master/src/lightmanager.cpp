...
void LightManager::initLights() {
	lights.push_back(new Light(Vector3(0, 500.0, 500.0), Vector3(65, 81, 98), 10.0, 1000.0, 0.1)); //medianoche:(65, 81, 98) luna:(247, 225, 195) blood_moon:(212, 48, 54)
	lights.push_back(new Light(Vector3(0, 0, 0), Vector3(215, 178, 49)*0.5, 5.0, 12.0, 0.15));
